...
<body>
    ...
    <div class="container">
        ...
        <form style="margin: 0 12%" method="get" action="ControladorLibros">
			<input type="hidden" name="instruccion" value="actualizarBBDD">
			<input type="hidden" name="idlibro" value="${ UpdateLibro.idlibro }">    
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="idlibro" class="form-label"><b>Id Libro:</b></label>
                    <input type="text" class="form-control" id="idlibro" name="idlibro" value="${ UpdateLibro.idlibro }" disabled>
                </div>
                <div class="col-md-6">
                    <label for="titulo" class="form-label"><b>Titulo:</b></label>
                    <input type="text" class="form-control" id="titulo" name="titulo" value="${ UpdateLibro.titulo }">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="autor" class="form-label"><b>Autor:</b></label>
                    <input type="text" class="form-control" id="autor" name="autor" value="${ UpdateLibro.autor }">
                </div>
                <div class="col-md-6">
                    <label for="editorial" class="form-label"><b>Editorial:</b></label>
                    <input type="text" class="form-control" id="editorial" name="editorial" value="${ UpdateLibro.editorial }">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="stock" class="form-label"><b>Stock:</b></label>
                    <input type="text" class="form-control" id="stock" name="stock" value="${ UpdateLibro.stock }">
                </div>
                <div class="col-md-6">
                    <label for="estado" class="form-label"><b>Estado:</b></label>
                    <input type="text" class="form-control" id="estado" name="estado" value="${ UpdateLibro.estado }">
                    <!--select class="form-select" id="estado" name="estado">
                        <option selected>Seleccionar</option>
                        <option value="disponible">Disponible</option>
                        <option value="prestado">Agotado</option>
                    </select-->
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 text-center">
                    <br><input type="submit" name="enviar" id="enviar" value="Editar Libro"
