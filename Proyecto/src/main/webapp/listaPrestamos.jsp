...
<body class="bg-light">
	...
	<br>
    <h1 class="d-flex justify-content-center" style="text-transform: uppercase;"><strong>Lista de Préstamos</strong></h1>
    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td><a class="btn btn-outline-success" href="editarPrestamo.jsp">Editar</a>
