...
<%
	List<Libro> losLibros = (List<Libro>) request.getAttribute("ListarLibros");
%>
...
<body class="bg-light">
    ...
    <br>
    <h1 class="d-flex justify-content-center" style="text-transform: uppercase;"><strong>Lista de Libros</strong></h1>
    ...
    <div class="container">
        ...
        <table class="table table-striped">
			...
			<% for (Libro temporal: losLibros) { %>
            <tr>
                <th><%= temporal.getIdlibro() %></th>
                <td><%= temporal.getTitulo() %></td>
                <td><%= temporal.getAutor() %></td>
                <td><%= temporal.getEditorial() %></td>
                <td><%= temporal.getStock() %></td>
                <td><%= temporal.getEstado() %></td>
                <td><a class="btn btn-outline-success" href="ControladorLibros?instruccion=cargar&codigo=<%= temporal.getIdlibro() %>">Editar</a>
                    <a class="btn btn-outline-danger" href="#" onclick="confirmarEliminacion(<%= temporal.getIdlibro() %>)">Eliminar</a>
                </td>
            </tr>
            <%} %>
        </table>
        ...
        <div class="d-flex justify-content-center">
            <input class="btn btn-primary" type="button" value="Crear Libro" style="color: #fff; font-weight:600"
...
<script>
	function confirmarEliminacion(codigo) {
		if (confirm("¿Estás seguro de que deseas eliminar este registro?")) {
			window.location.href = "ControladorLibros?instruccion=eliminar&codigo=" + codigo;
		}
	}
</script>
