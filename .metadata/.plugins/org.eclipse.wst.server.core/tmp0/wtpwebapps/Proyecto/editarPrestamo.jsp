...
<body>
    ...
    <div class="container">
        <br>
        <h1 class="text-center" style="text-transform: uppercase;"><strong>Editar Prestamo</strong></h1><br>
        <form style="margin: 0 12%">
            ...
            <div class="row mb-3">
            	<div class="col-md-6">
                    <label for="fechaprestamo" class="form-label"><b>Fecha Prestamo:</b></label>
                    <input type="date" class="form-control" id="fechaprestamo" name="fechaprestamo">
                </div>
                <div class="col-md-6">
                    <label for="fechadevolucion" class="form-label"><b>Fecha Devolución:</b></label>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="nombre" class="form-label"><b>ID Alumno:</b></label>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <br><input type="submit" name="editar" id="editar" value="Editar Libro"
