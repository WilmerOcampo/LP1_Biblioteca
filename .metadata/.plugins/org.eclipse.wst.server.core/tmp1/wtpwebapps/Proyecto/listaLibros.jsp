    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><a class="btn btn-outline-success" href="ControladorLibros?instruccion=cargar&idlibro=<%= temporal.getIdlibro() %>">Editar</a>
                    <a class="btn btn-outline-danger" onclick="confirmarEliminacion(<%= temporal.getIdlibro()%>)">Eliminar</a>
                    <a class="btn btn-outline-danger" onclick="confirmarEliminacion(<%= temporal.getIdlibro()%>)">Eliminar</a>
                </td>
            </tr>
            <%} %>
...
<script>
	function confirmarEliminacion(idlibro) {
		if (confirm("¿Estás seguro de que deseas eliminar este registro?")) {
			window.location.href = "ControladorLibros?instruccion=eliminar&idlibro=" + idlibro;
		}
	}
</script>
