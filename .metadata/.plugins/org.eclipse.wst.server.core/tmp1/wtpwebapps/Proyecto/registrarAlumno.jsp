...
<body class="bg-light">
    ...
    <div class="container">
        <br>
        <h1 class="text-center" style="text-transform: uppercase;"><strong>Registrar Alumno</strong></h1><br>
        <form style="margin: 0 12%" method="get" action="ControladorAlumnos">
        <input type="hidden" name="instruccion" value="insertarBBDD">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <br><input type="submit" name="registrar" id="registrar" value="Registrar Alumno" class="btn btn-primary" style="font-weight: 600">
