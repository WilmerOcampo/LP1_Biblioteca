...
<body class="bg-light">
    ...
    <div class="container">
        <br>
        <h1 class="text-center" style="text-transform: uppercase;"><strong>Editar Empleado</strong></h1><br>
        <form style="margin: 0 12%">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <br><input type="submit" name="editar" id="editar" value="Editar Empleado" class="btn btn-primary" style="font-weight: 600">
