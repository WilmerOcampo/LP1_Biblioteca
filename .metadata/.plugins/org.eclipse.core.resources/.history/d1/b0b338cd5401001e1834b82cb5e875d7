...
<body class="bg-light">
	...
	<br>
    <h1 class="d-flex justify-content-center" style="text-transform: uppercase;"><strong>Lista de Compras</strong></h1>
    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td><a class="btn btn-outline-success" href="editarCompras.jsp">Editar</a>
        ...
        <div class="d-flex justify-content-center">
            <input class="btn btn-primary" type="button" value="Registrar Compra " style="color: #fff; font-weight:600"
                onclick="window.location.href='registrarCompras.jsp'">
        </div>
